    ...
    static public void setupdate(String eId, String emailId, String userPassword, String confirmPassword, String name, String age, String address, String department, String designation, String basicSalary) {
        ...
        try {
            ...
            if(userPassword.length()<8) {
                ...
                if(x > 0) {
                    JOptionPane.showMessageDialog(new JFrame(), "Successfully updated!", "Update", JOptionPane.PLAIN_MESSAGE);
                }
                else {
                    JOptionPane.showMessageDialog(new JFrame(), "Failed to update!", "Update", JOptionPane.PLAIN_MESSAGE);
                }
            }
            con.close();
