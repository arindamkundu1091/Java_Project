    ...
    static public void dataEntry(String emailId, String userPassword, String confirmPassword, String name, String age, String address, String department, String designation, String basicSalary) {
        ...
        try {
            ...
            if(emailId.equals(null)) {
                ...
                if(x > 0) {
                    JOptionPane.showMessageDialog(new JFrame(), "Successfully registered!", "Register", JOptionPane.PLAIN_MESSAGE);
                }
                else {
                    JOptionPane.showMessageDialog(new JFrame(), "Failed to register!", "Register", JOptionPane.PLAIN_MESSAGE);
                }
            }
            con.close();
